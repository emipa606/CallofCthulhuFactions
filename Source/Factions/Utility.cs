    ...
    public static class Utility
    {
        ...
        public static IEnumerable<CellRectRot> AdjacentHallwayAreas(CellRect hallway, out IEnumerable<IntVec3> doorLocs)
        {
            ...
            if (greaterWidth)
            {
                ...
                {
                    //Westbound
                    returnList.Add(new CellRectRot(AdjacentRectMaker(hallway, Rot4.West, out doorLoc, hallway.Width), Rot4.West));
                    doorLocsResult.Add(doorLoc);
                }
                else if (hallway.CenterCell.x >= map.Center.x)
                {
                    //Eastbound
                    returnList.Add(new CellRectRot(AdjacentRectMaker(hallway, Rot4.East, out doorLoc, hallway.Width), Rot4.East));
                    doorLocsResult.Add(doorLoc);
                }

                //Northbound
                returnList.Add(new CellRectRot(AdjacentRectMaker(hallway, Rot4.North, out doorLoc, hallway.Width), Rot4.North));
                doorLocsResult.Add(doorLoc);

                //Southbound
                returnList.Add(new CellRectRot(AdjacentRectMaker(hallway, Rot4.South, out doorLoc, hallway.Width), Rot4.South));
                doorLocsResult.Add(doorLoc);
            }
            else
            {
                ...
                {
                    //Northbound
                    returnList.Add(new CellRectRot(AdjacentRectMaker(hallway, Rot4.North, out doorLoc, hallway.Height), Rot4.North));
                    doorLocsResult.Add(doorLoc);
                }
                else if (hallway.CenterCell.z <= map.Center.z)
                {
                    //Southbound
                    returnList.Add(new CellRectRot(AdjacentRectMaker(hallway, Rot4.South, out doorLoc, hallway.Height), Rot4.South));
                    doorLocsResult.Add(doorLoc);
                }

                //Eastbound
                returnList.Add(new CellRectRot(AdjacentRectMaker(hallway, Rot4.East, out doorLoc, hallway.Height), Rot4.East));
                doorLocsResult.Add(doorLoc);

                //Westbound
                returnList.Add(new CellRectRot(AdjacentRectMaker(hallway, Rot4.West, out doorLoc, hallway.Height), Rot4.West));
                doorLocsResult.Add(doorLoc);
            }
