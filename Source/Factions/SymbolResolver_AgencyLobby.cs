...
namespace CthulhuFactions
{
    public class SymbolResolver_AgencyLobby : SymbolResolverAgency
    {
        public override void PassingParameters(ResolveParams rp)
        {
            ...
            _ = IntVec3.Invalid;
            eastParams.rect = Utility.AdjacentRectMaker(rp.rect, Rot4.East, out IntVec3 doorLoc, (int)RectSizeValues.HALLWAYLENGTH, (int)RectSizeValues.HALLWAYSIZE);
            ...
            _ = IntVec3.Invalid;
            westParams.rect = Utility.AdjacentRectMaker(rp.rect, Rot4.West, out IntVec3 doorLoc2, (int)RectSizeValues.HALLWAYLENGTH, (int)RectSizeValues.HALLWAYSIZE);
            ...
            _ = IntVec3.Invalid;
            northParams.rect = Utility.AdjacentRectMaker(rp.rect, Rot4.North, out IntVec3 doorLoc3, (int)RectSizeValues.HALLWAYSIZE, (int)RectSizeValues.HALLWAYLENGTH);
            _ = ThingMaker.MakeThing(CthulhuFactionsDefOf.ROM_TemporaryDoorMarker, null);
            ...
            _ = IntVec3.Invalid;
            northParams2.rect = Utility.AdjacentRectMaker(northParams.rect, Rot4.North, out IntVec3 doorLoc4, (int)RectSizeValues.HALLWAYSIZE, (int)RectSizeValues.HALLWAYLENGTH);
